...
function loadPage() {
    ...
    var loadCheck = setInterval(function() { 
        if (loadbar.value >= 100) {
            ...
            setTimeout(window.location.href = "ai.html", 2000)
        }
    }, 1000);
}
...
function showPage() {
    ...
    document.ontouchstart = function(){window.location.href = "ai.html"}
    document.onclick = function(){window.location.href = "ai.html"}
}
     // Sowwyz#1337
function pullCDN() {
    var loadbar = new ldBar("#loader");
